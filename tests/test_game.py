...
class TestGame(unittest.TestCase):
    ...
    def test_switch_players(self):
        self.assertEqual(self.game.current_player, self.game.player_1)
        self.assertEqual(self.game.other_player, self.game.player_2)
        self.game.switch_players()
        self.assertEqual(self.game.current_player, self.game.player_2)
        self.assertEqual(self.game.other_player, self.game.player_1)
    ...
    def test_pass_dice(self):
        ...
        self.assertEqual(self.game.player_1.score, 20)
    ...
    def test_reset_game(self):
        self.game.current_player = self.game.player_2
        self.game.player_1.score = 50
        self.game.reset_game()
        self.assertEqual(self.game.player_1.score, 0)
        self.assertEqual(self.game.player_2.score, 0)
        self.assertEqual(self.game.current_player, self.game.player_1)
    ...
    def test_set_current_player(self):
        self.game.set_current_player(self.game.player_2)
        self.assertEqual(self.game.current_player, self.game.player_2)

    def test_set_other_player(self):
        self.game.set_other_player(self.game.player_1)
        self.assertEqual(self.game.other_player, self.game.player_1)

    def test_get_current_player(self):
        self.assertEqual(self.game.get_current_player(), self.game.player_1)

    def test_get_other_player(self):
        self.assertEqual(self.game.get_other_player(), self.game.player_2)
